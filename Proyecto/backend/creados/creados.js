...
switch (yystate) {
case 1:
temp.push(nodosAPI.agregarNodo('Prod_A1','S'));temp.push(nodosAPI.agregarNodo('S','')); return temp;
break;
case 2:
temp.push(nodosAPI.agregarNodo($$[$0-2],'Una_A1')); temp.push(nodosAPI.agregarNodo('Una_A1','Prod_A'));temp.push(nodosAPI.agregarNodo($$[$0-1],'Mas2')); temp.push(nodosAPI.agregarNodo('Mas2','Prod_A'));temp.push(nodosAPI.agregarNodo($$[$0],'Una_A3')); temp.push(nodosAPI.agregarNodo('Una_A3','Prod_A'));
break;
}
},
